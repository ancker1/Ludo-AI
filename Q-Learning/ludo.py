...
class LudoQLearner:
    ...
    def __init__(self, Q_DICT, learning_rate = 0.1, discount_factor = 0.5, training=True, _type=0):
...
players = [ LudoQLearner(Q_DICT, training=TRAINING, _type=3), LudoPlayerRandom(), LudoPlayerRandom(), LudoPlayerRandom()  ]
