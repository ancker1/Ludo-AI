...
class GANNIndividual:
    ...
    input_size  = 4 * 59 + 1 # 4 tokens per player
    output_size = 4     # only 4 actions
    hidden_neurons = 100 # 20 hidden neurons
